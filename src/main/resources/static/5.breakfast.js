...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BreakfastOrdersContainer = __webpack_require__(611);

	var _BreakfastOrdersContainer2 = _interopRequireDefault(_BreakfastOrdersContainer);

	var _BreakfastMenuContainer = __webpack_require__(615);

	var _BreakfastMenuContainer2 = _interopRequireDefault(_BreakfastMenuContainer);

	__webpack_require__(626);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var Breakfast = function (_Component) {
	  (0, _inherits3.default)(Breakfast, _Component);

	  function Breakfast(props) {
	    (0, _classCallCheck3.default)(this, Breakfast);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (Breakfast.__proto__ || (0, _getPrototypeOf2.default)(Breakfast)).call(this, props));
	    ...
	    _this.state = {
	      headers: [{
	        ...
	        id: "orders",
	        isActive: true,
	        component: _react2.default.createElement(_BreakfastOrdersContainer2.default, null)
	      }, {
	        name: "Breakfast menu",
	        id: "numbers",
	        isActive: false,
	        component: _react2.default.createElement(_BreakfastMenuContainer2.default, null)
	      }]
	    };
	    return _this;
	  }

	  (0, _createClass3.default)(Breakfast, [{
	    key: 'handleTabSwitch',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BreakfastOrders = __webpack_require__(612);

	var _BreakfastOrders2 = _interopRequireDefault(_BreakfastOrders);
	...
	var BreakfastOrdersContainer = function (_Component) {
	  (0, _inherits3.default)(BreakfastOrdersContainer, _Component);

	  function BreakfastOrdersContainer(props) {
	    (0, _classCallCheck3.default)(this, BreakfastOrdersContainer);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (BreakfastOrdersContainer.__proto__ || (0, _getPrototypeOf2.default)(BreakfastOrdersContainer)).call(this, props));

	    _this.handleStatusChange = _this.handleStatusChange.bind(_this);
	    _this.entriesToStr = _this.entriesToStr.bind(_this);
	    return _this;
	  }

	  (0, _createClass3.default)(BreakfastOrdersContainer, [{
	    ...
	    value: function handleStatusChange(roomNumber, orderId, newStatus) {
	      ...
	      (0, _keys2.default)(stays.entries).forEach(function (pin) {
	        ...
	        if (stay.roomNumber === roomNumber) {
	          _this2.props.dispatch((0, _actions.changeBreakfastOrderStatus)(stay.pin, orderId, { status: newStatus }));
	        }
	      });
	    }
	  }, {
	    key: 'entriesToStr',
	    value: function entriesToStr(entries) {
	      var entryStrArray = [];
	      entries.forEach(function (entry) {
	        if (entry.count > 1) {
	          var str = entry.item.name + ' (' + entry.count + 'x)';
	          entryStrArray.push(str);
	        } else {
	          var _str = entry.item.name;
	          entryStrArray.push(_str);
	        }
	      });

	      var sortedEntryStrArray = entryStrArray.sort();
	      return sortedEntryStrArray.join(', ');
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      (0, _keys2.default)(stays.entries).forEach(function (pin) {
	        var stay = stays.entries[pin];
	        if (stay.status === "ACTIVE") stay.orders.breakfastOrders.forEach(function (order) {
	          var orderData = {
	            id: order.id,
	            roomNumber: stay.roomNumber,
	            items: _this3.entriesToStr(order.entries),
	            total: order.total.value + order.total.currency,
	            time: order.time,
	            status: order.status
	          };
	      ...
	      orders.sort(breakfastOrdersComparator);
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_BreakfastOrders2.default, { orders: orders,
	  ...
	  return BreakfastOrdersContainer;
	}(_react.Component);
	...
	BreakfastOrdersContainer = (0, _reactRedux.connect)(mapStateToProps, null)(BreakfastOrdersContainer);
	exports.default = BreakfastOrdersContainer;


	var breakfastOrdersComparator = function breakfastOrdersComparator(orderA, orderB) {
	  if (orderA.roomNumber < orderB.roomNumber) return -1;else if (orderA.roomNumber > orderB.roomNumber) return 1;else {
	    if (orderA.items < orderB.items) return -1;else return 1;
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BreakfastOrdersEntry = __webpack_require__(613);

	var _BreakfastOrdersEntry2 = _interopRequireDefault(_BreakfastOrdersEntry);
	...
	var BreakfastOrders = function (_Component) {
	  (0, _inherits3.default)(BreakfastOrders, _Component);

	  function BreakfastOrders() {
	    (0, _classCallCheck3.default)(this, BreakfastOrders);
	    return (0, _possibleConstructorReturn3.default)(this, (BreakfastOrders.__proto__ || (0, _getPrototypeOf2.default)(BreakfastOrders)).apply(this, arguments));
	  }

	  (0, _createClass3.default)(BreakfastOrders, [{
	    key: 'render',
	    value: function render() {
	      var _props = this.props,
	      ...
	      var entries = orders.map(function (order, index) {
	        return _react2.default.createElement(_BreakfastOrdersEntry2.default, { key: index + 1, order: order, handleStatusChange: handleStatusChange });
	      });
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'breakfast col-xs-offset-2 col-xs-8' },
	              _react2.default.createElement(
	                'table',
	...
	exports.default = BreakfastOrders;


	BreakfastOrders.propTypes = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BreakfastOrdersEntry = function (_Component) {
	  (0, _inherits3.default)(BreakfastOrdersEntry, _Component);

	  function BreakfastOrdersEntry(props) {
	    (0, _classCallCheck3.default)(this, BreakfastOrdersEntry);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (BreakfastOrdersEntry.__proto__ || (0, _getPrototypeOf2.default)(BreakfastOrdersEntry)).call(this, props));

	    _this.handleStatusChange = _this.handleStatusChange.bind(_this);
	    return _this;
	  }

	  (0, _createClass3.default)(BreakfastOrdersEntry, [{
	    key: 'handleStatusChange',
	  ...
	  return BreakfastOrdersEntry;
	}(_react.Component);

	exports.default = BreakfastOrdersEntry;


	BreakfastOrdersEntry.propTypes = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BreakfastMenu = __webpack_require__(622);

	var _BreakfastMenu2 = _interopRequireDefault(_BreakfastMenu);

	var _actions = __webpack_require__(546);

	var types = _interopRequireWildcard(_actions);

	var _actions2 = __webpack_require__(609);

	var breakfastTypes = _interopRequireWildcard(_actions2);

	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var BreakfastMenuContainer = function (_Component) {
	  (0, _inherits3.default)(BreakfastMenuContainer, _Component);

	  function BreakfastMenuContainer(props) {
	    (0, _classCallCheck3.default)(this, BreakfastMenuContainer);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (BreakfastMenuContainer.__proto__ || (0, _getPrototypeOf2.default)(BreakfastMenuContainer)).call(this, props));

	    _this.handleAddBreakfastItem = _this.handleAddBreakfastItem.bind(_this);
	    _this.handleUpdateBreakfastItem = _this.handleUpdateBreakfastItem.bind(_this);
	    _this.handleSetBreakfastItemAsUnavailable = _this.handleSetBreakfastItemAsUnavailable.bind(_this);
	    _this.extractItemsFromMenu = _this.extractItemsFromMenu.bind(_this);
	    _this.addInfoAboutModification = _this.addInfoAboutModification.bind(_this);
	    _this.extractBreakfastOrdersFromStays = _this.extractBreakfastOrdersFromStays.bind(_this);
	    return _this;
	  }

	  (0, _createClass3.default)(BreakfastMenuContainer, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var _this2 = this;

	      this.props.dispatch(breakfastTypes.fetchBreakfastMenu());
	      setInterval(function () {
	        return _this2.props.dispatch(breakfastTypes.fetchBreakfastMenu());
	      }, 5000);
	    }
	  }, {
	    key: 'handleAddBreakfastItem',
	    value: function handleAddBreakfastItem(model) {
	      this.props.dispatch(breakfastTypes.addBreakfastItem(model));
	      this.props.dispatch(breakfastTypes.fetchBreakfastMenu());
	    }
	  }, {
	    key: 'handleUpdateBreakfastItem',
	    value: function handleUpdateBreakfastItem(model) {
	      this.props.dispatch(breakfastTypes.updateBreakfastItem(model));
	      this.props.dispatch(breakfastTypes.fetchBreakfastMenu());
	    }
	  }, {
	    key: 'handleSetBreakfastItemAsUnavailable',
	    value: function handleSetBreakfastItemAsUnavailable(item) {
	      this.props.dispatch(breakfastTypes.setBreakfastItemAsUnavailable(item));
	      this.props.dispatch(breakfastTypes.fetchBreakfastMenu());
	    }
	  }, {
	    key: 'extractItemsFromMenu',
	    value: function extractItemsFromMenu(breakfastMenu) {
	      var items = [];
	      breakfastMenu.menu.map(function (type) {
	        var itemsSpecificType = type.items.map(function (item) {
	          return (0, _assign2.default)({}, { type: type.name }, item);
	        });
	        items.push.apply(items, (0, _toConsumableArray3.default)(itemsSpecificType));
	      });
	      return items;
	    }
	  }, {
	    key: 'addInfoAboutModification',
	    value: function addInfoAboutModification(breakfastItems, orders) {
	      return breakfastItems.map(function (itemData) {
	        var isModificationAllowed = true;

	        orders.forEach(function (order) {
	          order.entries.forEach(function (entry) {
	            var item = entry.item;
	            if (item.id === itemData.id) isModificationAllowed = false;
	          });
	        });

	        return (0, _extends3.default)({}, itemData, { isModificationAllowed: isModificationAllowed });
	      });
	    }
	  }, {
	    key: 'extractBreakfastOrdersFromStays',
	    value: function extractBreakfastOrdersFromStays(stays) {
	      var orders = [];
	      (0, _keys2.default)(stays.entries).forEach(function (pin) {
	        var stay = stays.entries[pin];
	        if (stay.status === "ACTIVE") stay.orders.breakfastOrders.forEach(function (order) {
	    ...
	    value: function render() {
	      var _props = this.props,
	          breakfastMenu = _props.breakfastMenu,
	          stays = _props.stays,
	          generic = _props.generic;

	      var items = this.extractItemsFromMenu(breakfastMenu);
	      var availableItems = items.filter(function (item) {
	        return item.available;
	      }).sort(breakfastItemsComparator);
	      var orders = this.extractBreakfastOrdersFromStays(stays);
	      var itemsWithModificationInfo = this.addInfoAboutModification(availableItems, orders);
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_BreakfastMenu2.default, { items: itemsWithModificationInfo,
	          handleAddBreakfastItem: this.handleAddBreakfastItem,
	          handleUpdateBreakfastItem: this.handleUpdateBreakfastItem,
	          handleRemoveBreakfastItem: this.handleSetBreakfastItemAsUnavailable,
	          isPendingAction: isPendingAction
	        })
	      );
	    }
	...
	var mapStateToProps = function mapStateToProps(state) {
	  return {
	    breakfastMenu: state.breakfastMenu,
	    stays: state.stays,
	    generic: state.generic
	  };
	};

	BreakfastMenuContainer = (0, _reactRedux.connect)(mapStateToProps, null)(BreakfastMenuContainer);
	exports.default = BreakfastMenuContainer;


	var breakfastItemsComparator = function breakfastItemsComparator(itemA, itemB) {
	  if (itemA.type < itemB.type) return -1;else if (itemA.type > itemB.type) return 1;else {
	    if (itemA.name < itemB.name) return -1;else return 1;
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _from = __webpack_require__(617);
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(621)(function(iter){ Array.from(iter); }), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BreakfastMenuEntry = __webpack_require__(623);

	var _BreakfastMenuEntry2 = _interopRequireDefault(_BreakfastMenuEntry);

	var _BreakfastMenuModal = __webpack_require__(624);

	var _BreakfastMenuModal2 = _interopRequireDefault(_BreakfastMenuModal);
	...
	var BreakfastMenu = function (_Component) {
	  (0, _inherits3.default)(BreakfastMenu, _Component);

	  function BreakfastMenu(props) {
	    (0, _classCallCheck3.default)(this, BreakfastMenu);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (BreakfastMenu.__proto__ || (0, _getPrototypeOf2.default)(BreakfastMenu)).call(this, props));

	    _this.handleAddBreakfastItem = _this.handleAddBreakfastItem.bind(_this);
	    _this.handleEditBreakfastItem = _this.handleEditBreakfastItem.bind(_this);
	    _this.handleRemoveBreakfastItem = _this.handleRemoveBreakfastItem.bind(_this);
	    _this.handleSaveBreakfastItem = _this.handleSaveBreakfastItem.bind(_this);
	    ...
	    _this.state = {
	      modal: {
	        modalData: {
	          id: 'breakfastMenuModal',
	          title: 'Adding a new breakfast item',
	          canSubmit: false
	        },
	  ...
	  (0, _createClass3.default)(BreakfastMenu, [{
	    key: 'handleAddBreakfastItem',
	    value: function handleAddBreakfastItem() {
	    ...
	    key: 'handleEditBreakfastItem',
	    value: function handleEditBreakfastItem(id) {
	      var model = null;
	    ...
	    key: 'handleRemoveBreakfastItem',
	    value: function handleRemoveBreakfastItem(id) {
	      ...
	      this.props.handleRemoveBreakfastItem(toRemove);
	    }
	  }, {
	    key: 'handleSaveBreakfastItem',
	    value: function handleSaveBreakfastItem(model) {
	      var currentId = this.state.modal.model.id;
	      if (currentId === -1) this.props.handleAddBreakfastItem(model);else this.props.handleUpdateBreakfastItem((0, _extends3.default)({}, model, { id: currentId }));
	    ...
	    value: function render() {
	      ...
	      var entries = items.map(function (item, index) {
	        return _react2.default.createElement(_BreakfastMenuEntry2.default, { key: index + 1,
	          nr: index + 1,
	          item: item,
	          handleEditBreakfastItem: _this2.handleEditBreakfastItem,
	          handleRemoveBreakfastItem: _this2.handleRemoveBreakfastItem
	        });
	      });
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'breakfast-menu col-xs-offset-3 col-xs-6' },
	              _react2.default.createElement(
	                'button',
	                { onClick: function onClick(event) {
	                    event.preventDefault();_this2.handleAddBreakfastItem();
	                  },
	        ...
	        _react2.default.createElement(_BreakfastMenuModal2.default, { modalData: this.state.modal.modalData,
	          model: this.state.modal.model,
	          handleOnValid: this.handleModelValid,
	          handleOnInvalid: this.handleModelInvalid,
	          handleSaveBreakfastItem: this.handleSaveBreakfastItem
	        })
	      );
	    }
	  }]);
	...
	exports.default = BreakfastMenu;


	BreakfastMenu.propTypes = {
	  items: _react.PropTypes.array.isRequired,
	  isPendingAction: _react.PropTypes.bool.isRequired,
	  handleAddBreakfastItem: _react.PropTypes.func.isRequired,
	  handleUpdateBreakfastItem: _react.PropTypes.func.isRequired,
	  handleRemoveBreakfastItem: _react.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BreakfastMenuEntry = function (_Component) {
	  (0, _inherits3.default)(BreakfastMenuEntry, _Component);

	  function BreakfastMenuEntry() {
	    (0, _classCallCheck3.default)(this, BreakfastMenuEntry);
	    return (0, _possibleConstructorReturn3.default)(this, (BreakfastMenuEntry.__proto__ || (0, _getPrototypeOf2.default)(BreakfastMenuEntry)).apply(this, arguments));
	  }

	  (0, _createClass3.default)(BreakfastMenuEntry, [{
	    key: "render",
	    value: function render() {
	      var _props = this.props,
	          nr = _props.nr,
	          item = _props.item,
	          handleEditBreakfastItem = _props.handleEditBreakfastItem,
	          handleRemoveBreakfastItem = _props.handleRemoveBreakfastItem;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "div",
	            { className: "col-xs-6" + (item.isModificationAllowed ? " active" : "") },
	            _react2.default.createElement(
	              "a",
	              { href: "#", onClick: function onClick(e) {
	                  e.preventDefault();
	                  if (item.isModificationAllowed) handleEditBreakfastItem(item.id);
	                } },
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              "a",
	              { href: "#", onClick: function onClick(e) {
	                  e.preventDefault();handleRemoveBreakfastItem(item.id);
	                } },
	  ...
	  return BreakfastMenuEntry;
	}(_react.Component);

	exports.default = BreakfastMenuEntry;


	BreakfastMenuEntry.propTypes = {
	  nr: _react.PropTypes.number,
	  item: _react.PropTypes.object.isRequired,
	  handleEditBreakfastItem: _react.PropTypes.func.isRequired,
	  handleRemoveBreakfastItem: _react.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BreakfastMenuModal = function (_Component) {
	  (0, _inherits3.default)(BreakfastMenuModal, _Component);

	  function BreakfastMenuModal(props) {
	    (0, _classCallCheck3.default)(this, BreakfastMenuModal);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (BreakfastMenuModal.__proto__ || (0, _getPrototypeOf2.default)(BreakfastMenuModal)).call(this, props));

	    _this.handlePriceValidation = _this.handlePriceValidation.bind(_this);
	  ...
	  (0, _createClass3.default)(BreakfastMenuModal, [{
	    key: 'handlePriceValidation',
	    value: function handlePriceValidation(message) {
	      if (message === 'VALID' || message === 'INVALID_EMPTY') this.setState((0, _extends3.default)({}, this.state, { priceErrorMessage: '' }));else this.setState((0, _extends3.default)({}, this.state, { priceErrorMessage: 'This is not a valid price' }));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var _props = this.props,
	          ...
	          handleSaveBreakfastItem = _props.handleSaveBreakfastItem;


	      return _react2.default.createElement(
	        'div',
	        { id: modalData.id, className: 'breakfast-menu modal fade', tabIndex: '-1', role: 'dialog' },
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                _formsyReact.Form,
	                { onSubmit: handleSaveBreakfastItem,
	                  onValid: handleOnValid,
	                  onInvalid: handleOnInvalid,
	                  className: 'form-group breakfast-menu',
	                  role: 'form',
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(_StandardInput2.default, { value: model.name,
	                    name: 'name',
	                    title: 'Name',
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(_ComboBoxInput2.default, { options: this.types, value: model.type, name: 'type', title: 'Type' })
	                ),
	                _react2.default.createElement(
	                  'div',
	                  ...
	                  _react2.default.createElement(_StandardInput2.default, { value: model.price,
	                    name: 'price',
	                    title: 'Price',
	                    placeholder: '',
	                  ...
	                  _react2.default.createElement(_ComboBoxInput2.default, { options: this.currencies, value: model.currency, name: 'currency', title: 'Currency' }),
	                  _react2.default.createElement(
	                    'span',
	                    { className: 'validation-error' },
	  ...
	  return BreakfastMenuModal;
	}(_react.Component);

	exports.default = BreakfastMenuModal;


	BreakfastMenuModal.propTypes = {
	  ...
	  handleSaveBreakfastItem: _react.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var breakfastMenuReducer = function breakfastMenuReducer() {
	  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { menu: [], status: types.FETCH_BREAKFAST_MENU_NEW };
	  var action = arguments[1];

	  switch (action.type) {
	    case types.FETCH_BREAKFAST_MENU_NEW:
	    case types.FETCH_BREAKFAST_MENU_PENDING:
	    case types.FETCH_BREAKFAST_MENU_ERROR:
	      return (0, _extends3.default)({}, state, { status: action.type });
	    case types.FETCH_BREAKFAST_MENU_COMPLETED:
	      return (0, _extends3.default)({}, state, action.breakfastMenu, { status: action.type });
	...
	exports.default = breakfastMenuReducer;
