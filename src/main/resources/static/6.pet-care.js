webpackJsonp([6],Array(316).concat([
/* 316 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 23.2 Set Objects
	module.exports = __webpack_require__(346)('Set', function(get){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dP          = __webpack_require__(11).f
	  ...
	  , setSpecies  = __webpack_require__(344)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global         = __webpack_require__(6)
	  ...
	  , each           = __webpack_require__(347)(0)
	  , DESCRIPTORS    = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.R, 'Set', {toJSON: __webpack_require__(352)('Set')});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forOf = __webpack_require__(339);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(357)('keys', function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Formsy = {};
	var validationRules = __webpack_require__(400);
	var formDataToObject = __webpack_require__(401);
	var utils = __webpack_require__(402);
	var Mixin = __webpack_require__(403);
	var HOC = __webpack_require__(404);
	var Decorator = __webpack_require__(405);
	var options = {};
	var emptyArray = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _formsyReact = __webpack_require__(399);
	...
	var StandardInput = function (_Component) {
	  ...
	  (0, _createClass3.default)(StandardInput, [{
	    ...
	    value: function render() {
	      ...
	      var result = null;
	      if (handleValidationChange) result = _react2.default.createElement('input', { type: 'text',
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function (global, factory) {
	    true ? factory(__webpack_require__(427)) :
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _orderStates = __webpack_require__(586);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SectionHeader = __webpack_require__(540);

	var _SectionHeader2 = _interopRequireDefault(_SectionHeader);

	var _TabSwitcher = __webpack_require__(579);

	var _TabSwitcher2 = _interopRequireDefault(_TabSwitcher);

	var _PetCareOrdersContainer = __webpack_require__(632);

	var _PetCareOrdersContainer2 = _interopRequireDefault(_PetCareOrdersContainer);

	var _PetCareItemsContainer = __webpack_require__(636);

	var _PetCareItemsContainer2 = _interopRequireDefault(_PetCareItemsContainer);

	__webpack_require__(635);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var PetCare = function (_Component) {
	  (0, _inherits3.default)(PetCare, _Component);

	  function PetCare(props) {
	    (0, _classCallCheck3.default)(this, PetCare);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (PetCare.__proto__ || (0, _getPrototypeOf2.default)(PetCare)).call(this, props));
	    ...
	    _this.state = {
	      headers: [{
	        ...
	        id: "petCareOrders",
	        isActive: true,
	        component: _react2.default.createElement(_PetCareOrdersContainer2.default, null)
	      }, {
	        name: 'Offered Services',
	        id: 'petCareItems',
	        isActive: false,
	        component: _react2.default.createElement(_PetCareItemsContainer2.default, null)
	      }]
	    };
	    return _this;
	  }

	  (0, _createClass3.default)(PetCare, [{
	    key: 'handleTabSwitch',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PetCareOrders = __webpack_require__(633);

	var _PetCareOrders2 = _interopRequireDefault(_PetCareOrders);
	...
	var PetCareOrdersContainer = function (_Component) {
	  (0, _inherits3.default)(PetCareOrdersContainer, _Component);

	  function PetCareOrdersContainer(props) {
	    (0, _classCallCheck3.default)(this, PetCareOrdersContainer);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (PetCareOrdersContainer.__proto__ || (0, _getPrototypeOf2.default)(PetCareOrdersContainer)).call(this, props));

	    _this.handleStatusChange = _this.handleStatusChange.bind(_this);
	    return _this;
	  }

	  (0, _createClass3.default)(PetCareOrdersContainer, [{
	    ...
	    value: function handleStatusChange(roomNumber, orderId, newStatus) {
	      ...
	      (0, _keys2.default)(stays.entries).forEach(function (pin) {
	        ...
	        if (stay.roomNumber === roomNumber) {
	          _this2.props.dispatch((0, _actions.changePetCareOrderStatus)(stay.pin, orderId, { status: newStatus }));
	        }
	      });
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      (0, _keys2.default)(stays.entries).forEach(function (pin) {
	        var stay = stays.entries[pin];
	        if (stay.status === "ACTIVE") stay.orders.petCareOrders.forEach(function (order) {
	          var orderData = {
	            id: order.id,
	            roomNumber: stay.roomNumber,
	            name: order.item.name,
	            price: order.item.price.value + order.item.price.currency,
	            time: order.time,
	            status: order.status
	          };
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_PetCareOrders2.default, { orders: orders,
	...
	PetCareOrdersContainer = (0, _reactRedux.connect)(mapStateToProps, null)(PetCareOrdersContainer);
	exports.default = PetCareOrdersContainer;


	var byIdComparator = function byIdComparator(orderA, orderB) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SectionContent = __webpack_require__(542);

	var _SectionContent2 = _interopRequireDefault(_SectionContent);

	var _PetCareOrdersEntry = __webpack_require__(634);

	var _PetCareOrdersEntry2 = _interopRequireDefault(_PetCareOrdersEntry);

	__webpack_require__(635);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var PetCareOrders = function (_Component) {
	  (0, _inherits3.default)(PetCareOrders, _Component);

	  function PetCareOrders() {
	    (0, _classCallCheck3.default)(this, PetCareOrders);
	    return (0, _possibleConstructorReturn3.default)(this, (PetCareOrders.__proto__ || (0, _getPrototypeOf2.default)(PetCareOrders)).apply(this, arguments));
	  }

	  (0, _createClass3.default)(PetCareOrders, [{
	    key: 'render',
	    value: function render() {
	      var _props = this.props,
	      ...
	      var entries = orders.map(function (order, index) {
	        return _react2.default.createElement(_PetCareOrdersEntry2.default, { key: index + 1, order: order, handleStatusChange: handleStatusChange });
	      });
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'pet-care col-xs-offset-2 col-xs-8' },
	              _react2.default.createElement(
	                'table',
	...
	exports.default = PetCareOrders;


	PetCareOrders.propTypes = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _OrderStatusChanger = __webpack_require__(585);

	var _OrderStatusChanger2 = _interopRequireDefault(_OrderStatusChanger);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var PetCareOrdersEntry = function (_Component) {
	  (0, _inherits3.default)(PetCareOrdersEntry, _Component);

	  function PetCareOrdersEntry() {
	    var _ref;

	    var _temp, _this, _ret;

	    (0, _classCallCheck3.default)(this, PetCareOrdersEntry);

	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }

	    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = PetCareOrdersEntry.__proto__ || (0, _getPrototypeOf2.default)(PetCareOrdersEntry)).call.apply(_ref, [this].concat(args))), _this), _this.handleStatusChange = function (newStatus) {
	      var order = _this.props.order;

	      _this.props.handleStatusChange(order.roomNumber, order.id, newStatus);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'td',
	          null,
	          _react2.default.createElement(_OrderStatusChanger2.default, { status: order.status, handleStatusChange: _this.handleStatusChange })
	        )
	      );
	    }, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
	  }

	  return PetCareOrdersEntry;
	}(_react.Component);

	exports.default = PetCareOrdersEntry;


	PetCareOrdersEntry.propTypes = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.PetCareItemsContainer = undefined;
	...
	var _actions2 = __webpack_require__(630);

	var petCareTypes = _interopRequireWildcard(_actions2);

	var _PetCareItems = __webpack_require__(637);

	var _PetCareItems2 = _interopRequireDefault(_PetCareItems);

	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var PetCareItemsContainer = exports.PetCareItemsContainer = function (_Component) {
	  (0, _inherits3.default)(PetCareItemsContainer, _Component);

	  function PetCareItemsContainer() {
	    var _ref;

	    var _temp, _this, _ret;

	    (0, _classCallCheck3.default)(this, PetCareItemsContainer);

	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }

	    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = PetCareItemsContainer.__proto__ || (0, _getPrototypeOf2.default)(PetCareItemsContainer)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidMount = function () {
	      _this.props.dispatch(petCareTypes.fetchPetcare());
	      setInterval(function () {
	        return _this.props.dispatch(petCareTypes.fetchPetcare());
	      }, 5000);
	    }, _this.handleSaveItem = function (item) {
	      var dispatch = _this.props.dispatch;

	      if (item.id) dispatch(petCareTypes.updatePetCareItem(item));else dispatch(petCareTypes.addPetCareItem(item));

	      dispatch(petCareTypes.fetchPetcare());
	    }, _this.handleDeleteItem = function (id) {
	      _this.props.dispatch(petCareTypes.deletePetCareItem(id));
	    }, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
	  }

	  (0, _createClass3.default)(PetCareItemsContainer, [{
	    key: 'render',
	    value: function render() {
	      var _props = this.props,
	          petCare = _props.petCare,
	          generic = _props.generic;

	      var petCareItemsSorted = petCare.items.sort(byIdComparator);
	      ...
	      return _react2.default.createElement(_PetCareItems2.default, { items: petCareItemsSorted,
	...
	exports.PetCareItemsContainer = PetCareItemsContainer = (0, _reactRedux.connect)(mapStateToProps, null)(PetCareItemsContainer);
	exports.default = PetCareItemsContainer;


	var byIdComparator = function byIdComparator(itemA, itemB) {
	  if (itemA.id < itemB.id) return -1;else return 1;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PetCareItemsEntry = __webpack_require__(638);

	var _PetCareItemsEntry2 = _interopRequireDefault(_PetCareItemsEntry);

	var _PetCareItemsModal = __webpack_require__(639);

	var _PetCareItemsModal2 = _interopRequireDefault(_PetCareItemsModal);
	...
	var PetCareItems = function (_Component) {
	  (0, _inherits3.default)(PetCareItems, _Component);

	  function PetCareItems(props) {
	    (0, _classCallCheck3.default)(this, PetCareItems);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (PetCareItems.__proto__ || (0, _getPrototypeOf2.default)(PetCareItems)).call(this, props));

	    _this.handleAddItem = function () {
	      var model = _this.emptyModel;
	      var modalData = (0, _extends3.default)({}, _this.state.modal.modalData, { title: 'Adding a pet care service' });
	      var modal = { modalData: modalData, model: model };
	      _this.setState((0, _extends3.default)({}, _this.state, { modal: modal }));

	      (0, _jquery2.default)('#' + _this.state.modal.modalData.id).modal('show');
	    };

	    _this.handleEditItem = function (id) {
	      var model = _this.props.items.find(function (item) {
	        return item.id === id;
	      });
	      var modalData = (0, _extends3.default)({}, _this.state.modal.modalData, { title: 'Changing an existing pet care service' });
	      var modal = { modalData: modalData, model: model };
	      _this.setState((0, _extends3.default)({}, _this.state, { modal: modal }));
	    ...
	    _this.handleDeleteItem = function (id) {
	      _this.props.handleDeleteItem(id);
	    };

	    _this.handleSaveItem = function (item) {
	      _this.props.handleSaveItem(item);
	    };
	    ...
	    _this.state = {
	      modal: {
	        modalData: {
	          id: 'petCareItemsModal',
	          title: 'Adding a pet care service',
	          canSubmit: false
	        },
	  ...
	  (0, _createClass3.default)(PetCareItems, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	      ...
	      var _props = this.props,
	          ...
	          handleDeleteItem = _props.handleDeleteItem,
	          isPendingAction = _props.isPendingAction;


	      var entries = items.map(function (item, index) {
	        return _react2.default.createElement(_PetCareItemsEntry2.default, { key: index + 1,
	          nr: index + 1,
	          item: item,
	          handleEditItem: _this2.handleEditItem,
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'pet-care-items col-xs-offset-3 col-xs-6' },
	              _react2.default.createElement(
	                'button',
	                { onClick: function onClick(event) {
	                    event.preventDefault();_this2.handleAddItem();
	                  },
	        ...
	        _react2.default.createElement(_PetCareItemsModal2.default, { modalData: this.state.modal.modalData,
	...
	exports.default = PetCareItems;


	PetCareItems.propTypes = {
	  items: _react.PropTypes.array.isRequired,
	  handleSaveItem: _react.PropTypes.func.isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PetCareItemsEntry = function (_Component) {
	  (0, _inherits3.default)(PetCareItemsEntry, _Component);

	  function PetCareItemsEntry() {
	    (0, _classCallCheck3.default)(this, PetCareItemsEntry);
	    return (0, _possibleConstructorReturn3.default)(this, (PetCareItemsEntry.__proto__ || (0, _getPrototypeOf2.default)(PetCareItemsEntry)).apply(this, arguments));
	  }

	  (0, _createClass3.default)(PetCareItemsEntry, [{
	    key: "render",
	    value: function render() {
	      var _props = this.props,
	          nr = _props.nr,
	          item = _props.item,
	          handleEditItem = _props.handleEditItem,
	          handleDeleteItem = _props.handleDeleteItem;
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              { href: "#", onClick: function onClick(e) {
	                  e.preventDefault();handleEditItem(item.id);
	                } },
	  ...
	  return PetCareItemsEntry;
	}(_react.Component);

	exports.default = PetCareItemsEntry;


	PetCareItemsEntry.propTypes = {
	  nr: _react.PropTypes.number.isRequired,
	  item: _react.PropTypes.object.isRequired,
	  handleEditItem: _react.PropTypes.func.isRequired,
	  handleDeleteItem: _react.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getIterator2 = __webpack_require__(640);
	...
	var _reactDayPicker = __webpack_require__(645);

	var _reactDayPicker2 = _interopRequireDefault(_reactDayPicker);

	__webpack_require__(646);

	var _StandardInput = __webpack_require__(406);

	var _StandardInput2 = _interopRequireDefault(_StandardInput);

	var _ComboBoxInput = __webpack_require__(425);

	var _ComboBoxInput2 = _interopRequireDefault(_ComboBoxInput);

	var _CalendarHoursHolder = __webpack_require__(647);

	var _CalendarHoursHolder2 = _interopRequireDefault(_CalendarHoursHolder);

	var _jquery = __webpack_require__(408);

	var _jquery2 = _interopRequireDefault(_jquery);

	var _moment = __webpack_require__(427);

	var _moment2 = _interopRequireDefault(_moment);

	var _classnames = __webpack_require__(649);
	...
	var PetCareItemsModal = function (_Component) {
	  (0, _inherits3.default)(PetCareItemsModal, _Component);

	  function PetCareItemsModal(props) {
	    (0, _classCallCheck3.default)(this, PetCareItemsModal);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (PetCareItemsModal.__proto__ || (0, _getPrototypeOf2.default)(PetCareItemsModal)).call(this, props));

	    _this.componentDidMount = function () {
	      (0, _jquery2.default)('#' + _this.props.modalData.id).on('shown.bs.modal', function () {
	        return _this.copyPropsToState();
	      });
	    };

	    _this.copyPropsToState = function () {
	      var propsModel = _this.props.model;
	      var propsModalData = _this.props.modalData;

	      var model = JSON.parse((0, _stringify2.default)(propsModel));
	      model.calendar.days.forEach(function (day) {
	        return day.hours = _this.getSortedHoursForDay(day);
	      });
	      var modalData = JSON.parse((0, _stringify2.default)(propsModalData));

	      _this.setState({ modalData: modalData, model: model, ay: Math.random() });
	    };

	    _this.updateSubmitState = function (isFormValid) {
	      var modalData = (0, _assign2.default)({}, _this.state.modalData);

	      if (isFormValid) modalData.canSubmit = true;else modalData.canSubmit = false;

	      _this.setState((0, _extends3.default)({}, _this.state, { modalData: modalData }));
	    };

	    _this.handleOnSubmit = function () {
	      var formModel = _this.refs.petCareForm.getModel();
	      var toSave = _this.state.model;
	      toSave.name = formModel.name;
	      toSave.price.value = formModel.price;
	      toSave.price.currency = formModel.currency;
	      _this.props.handleSaveItem(toSave);

	      (0, _jquery2.default)('#' + _this.state.modalData.id).modal('hide');
	    };

	    _this.handlePriceValidation = function (message) {
	      if (message === 'VALID' || message === 'INVALID_EMPTY') _this.setState((0, _extends3.default)({}, _this.state, { priceErrorMessage: '' }));else _this.setState((0, _extends3.default)({}, _this.state, { priceErrorMessage: 'This is not a valid price' }));
	    };

	    _this.handleCalendarDayChange = function (e, day, _ref) {
	      var selected = _ref.selected;

	      _this.setState((0, _extends3.default)({}, _this.state, { selectedDay: selected ? null : day }));
	    };

	    _this.getHoursForSelectedDay = function () {
	      var model = _this.state.model;
	      var selectedDay = _this.state.selectedDay;
	      if (!selectedDay) return [];

	      var selectedDayMoment = (0, _moment2.default)(selectedDay);

	      var calendarDay = model.calendar.days.find(function (dayEntry) {
	        var modelDay = (0, _moment2.default)(dayEntry.day, 'DD-MM-YYYY');
	        if (modelDay.isSame(selectedDayMoment, 'day')) return true;
	      });

	      if (calendarDay) return calendarDay.hours;else return [];
	    };

	    _this.handleCalendarHourChange = function (index) {
	      var hour = _this.extractSelectedDay().hours[index];
	      hour.available = !hour.available;
	      _this.setState((0, _extends3.default)({}, _this.state));
	    };

	    _this.handleCalendarHourDelete = function (index) {
	      var extractedDay = _this.extractSelectedDay();
	      extractedDay.hours.splice(index, 1);
	      _this.setState((0, _extends3.default)({}, _this.state));
	    };

	    _this.handleNewCalendarHour = function (hour) {
	      var extractedDay = _this.extractSelectedDay();
	      if (extractedDay) {
	        extractedDay.hours.push({ hour: hour, available: true });
	        extractedDay.hours = _this.getSortedHoursForDay(extractedDay);
	      } else {
	        var newDay = {
	          day: (0, _moment2.default)(_this.state.selectedDay).format('DD-MM-YYYY'),
	          hours: [{ hour: hour, available: true }]
	        };
	        _this.state.model.calendar.days.push(newDay);
	      }

	      _this.setState((0, _extends3.default)({}, _this.state));
	    };

	    _this.extractSelectedDay = function () {
	      var selectedDay = (0, _moment2.default)(_this.state.selectedDay);
	      ...
	      try {
	        for (var _iterator = (0, _getIterator3.default)(_this.state.model.calendar.days), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          var dayEntry = _step.value;

	          var day = (0, _moment2.default)(dayEntry.day, 'DD-MM-YYYY');
	          if (day.isSame(selectedDay, 'day')) return dayEntry;
	        }
	      } catch (err) {
	    ...
	    _this.getSortedHoursForDay = function (day) {
	      var sortedHours = day.hours.sort(function (hourAEntry, hourBEntry) {
	        if (hourAEntry.hour < hourBEntry.hour) return -1;else return 1;
	      });
	      return sortedHours;
	    };
	  ...
	  (0, _createClass3.default)(PetCareItemsModal, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;

	      var submitButtonClasses = (0, _classnames2.default)('btn btn-primary', { 'disabled': !this.state.modalData.canSubmit });
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { id: this.state.modalData.id, className: 'pet-care-items pet-care-modal modal fade', tabIndex: '-1', role: 'dialog' },
	          _react2.default.createElement(
	            'div',
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  { onSubmit: this.handleOnSubmit,
	                    ...
	                    onValid: function onValid() {
	                      return _this2.updateSubmitState(true);
	                    },
	                    onInvalid: function onInvalid() {
	                      return _this2.updateSubmitState(false);
	                    }
	                  },
	                  _react2.default.createElement(
	                    'div',
	                    ...
	                    _react2.default.createElement(
	                      ...
	                      _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(_StandardInput2.default, { value: this.state.model.name,
	                          name: 'name',
	                          title: 'Name',
	                      ...
	                      _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(_StandardInput2.default, { value: this.state.model.price.value,
	                          name: 'price',
	                          title: 'Price',
	                          placeholder: '',
	                          validations: { matchRegexp: /^([0-9]*[.])?[0-9]+$/ },
	                          required: true,
	                          validationError: this.state.priceErrorMessage,
	                          handleValidationChange: this.handlePriceValidation
	                        }),
	                        _react2.default.createElement(_ComboBoxInput2.default, { options: this.currencies, value: this.state.model.price.currency, name: 'currency', title: 'Currency' }),
	                        _react2.default.createElement(
	                          'span',
	                          { className: 'validation-error' },
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                      ...
	                      _react2.default.createElement(
	                        'label',
	                        { htmlFor: 'petCareCalendar' },
	                        'Day'
	                      ),
	                      _react2.default.createElement(_reactDayPicker2.default, { onDayClick: this.handleCalendarDayChange,
	                    ...
	                    _react2.default.createElement(
	                      'div',
	                      { className: 'well' },
	                      _react2.default.createElement(_CalendarHoursHolder2.default, { hours: this.getHoursForSelectedDay(),
	                        handleHourChange: this.handleCalendarHourChange,
	                        handleHourDelete: this.handleCalendarHourDelete,
	                        handleNewHour: this.handleNewCalendarHour
	                      })
	                    )
	                  )
	                )
	                ...
	                _react2.default.createElement(
	                  ...
	                  { type: 'button',
	                    ...
	                    onClick: function onClick() {
	                      return _this2.state.modalData.canSubmit && _this2.handleOnSubmit();
	                    }
	                  },
	                  'Save'
	                )
	  ...
	  return PetCareItemsModal;
	}(_react.Component);

	exports.default = PetCareItemsModal;


	PetCareItemsModal.propTypes = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CalendarHour = __webpack_require__(648);
	...
	var CalendarHoursHolder = function (_Component) {
	  (0, _inherits3.default)(CalendarHoursHolder, _Component);

	  function CalendarHoursHolder(props) {
	    (0, _classCallCheck3.default)(this, CalendarHoursHolder);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (CalendarHoursHolder.__proto__ || (0, _getPrototypeOf2.default)(CalendarHoursHolder)).call(this, props));

	    _this.handleStatusChange = function (index) {
	      _this.props.handleHourChange(index);
	    };

	    _this.handleDeletion = function (index) {
	      _this.props.handleHourDelete(index);
	    };

	    _this.handleNewHour = function (hour) {
	      _this.props.handleNewHour(hour);
	    };

	    return _this;
	  }

	  (0, _createClass3.default)(CalendarHoursHolder, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	      ...
	      var showHours = hours.length > 0;

	      var hourComponents = hours.map(function (hour, index) {
	        return _react2.default.createElement(_CalendarHour2.default, { key: index,
	          index: index,
	          model: hour,
	          handleHourChange: _this2.handleStatusChange,
	          handleHourDelete: _this2.handleDeletion
	        });
	      });

	      return _react2.default.createElement(
	        'div',
	        { className: 'calendar-hours-holder' },
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(_TimePicker2.default, { handleNewHour: this.handleNewHour,
	            validationError: 'Invalid hour'
	          })
	        ),
	  ...
	  return CalendarHoursHolder;
	}(_react.Component);

	exports.default = CalendarHoursHolder;


	CalendarHoursHolder.propTypes = {
	  hours: _react.PropTypes.array.isRequired,
	  handleHourChange: _react.PropTypes.func.isRequired,
	  handleHourDelete: _react.PropTypes.func.isRequired,
	  handleNewHour: _react.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CalendarHour = function (_Component) {
	  (0, _inherits3.default)(CalendarHour, _Component);

	  function CalendarHour(props) {
	    (0, _classCallCheck3.default)(this, CalendarHour);
	    return (0, _possibleConstructorReturn3.default)(this, (CalendarHour.__proto__ || (0, _getPrototypeOf2.default)(CalendarHour)).call(this, props));
	  }

	  (0, _createClass3.default)(CalendarHour, [{
	    key: 'render',
	    value: function render() {
	      var _props = this.props,
	          index = _props.index,
	          ...
	          handleHourDelete = _props.handleHourDelete;


	      var labelClassNames = (0, _classnames2.default)('label', { 'label-success': model.available }, { 'label-danger': !model.available });
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          { className: labelClassNames,
	            onClick: function onClick() {
	              return handleHourChange(index);
	            }
	          },
	          model.hour,
	          _react2.default.createElement('div', { className: 'close-icon fa fa-times',
	            'aria-hidden': 'true',
	            onClick: function onClick(e) {
	              handleHourDelete(index);e.stopPropagation();
	            } })
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TimePicker = function (_Component) {
	  ...
	  function TimePicker(props) {
	    ...
	    _this.validateHour = function (value) {
	      var hour = (0, _moment2.default)(value, 'HH:mm', true);
	      if (hour.isValid()) return true;else return false;
	    };

	    _this.handleOnChange = function (hour) {
	      var hourValid = _this.validateHour(hour);
	      _this.setState((0, _extends3.default)({}, _this.state, { hour: hour, invalid: !hourValid }));
	    };

	    _this.handleNewHour = function () {
	      if (!_this.state.invalid) {
	        _this.setState((0, _extends3.default)({}, _this.state, { hour: '00:00', invalid: false }));
	        _this.props.handleNewHour(_this.state.hour);
	      }
	    };
	  ...
	  (0, _createClass3.default)(TimePicker, [{
	    ...
	    value: function render() {
	      ...
	      var _props = this.props,
	          handleNewHour = _props.handleNewHour,
	          validationError = _props.validationError;


	      var showErrorMessage = this.state.invalid && this.state.hour !== '';
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { type: 'text',
	          ...
	          onChange: function onChange(e) {
	            return _this2.handleOnChange(e.target.value);
	          },
	          onKeyDown: function onKeyDown(e) {
	            if (e.key === 'Enter') _this2.handleNewHour();
	          }
	        }),
	        _react2.default.createElement(
	          'div',
	          { className: 'plus-sign' },
	          !this.state.invalid && _react2.default.createElement('div', { className: 'fa fa-plus',
	            onClick: function onClick() {
	              return _this2.handleNewHour();
	            }
	          })
	        ),
	        showErrorMessage && _react2.default.createElement(
	          'span',
	          { className: 'validation-error' },
	          validationError
	        )
	...
	TimePicker.propTypes = {
	  handleNewHour: _react.PropTypes.func.isRequired,
	  validationError: _react.PropTypes.string.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var petCareReducer = function petCareReducer() {
	  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { items: [], status: types.FETCH_PETCARE_NEW };
	  var action = arguments[1];

	  switch (action.type) {
	    case types.FETCH_PETCARE_NEW:
	    case types.FETCH_PETCARE_PENDING:
	    case types.FETCH_PETCARE_ERROR:
	      return (0, _extends3.default)({}, state, { status: action.type });
	    case types.FETCH_PETCARE_COMPLETED:
	      return (0, _extends3.default)({}, state, action.petCare, { status: action.type });
	...
	exports.default = petCareReducer;
